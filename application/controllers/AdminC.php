...
class AdminC extends CI_Controller
{
    ...
    public function index(){
        ...
        $data['jumlah_skpa'] = $this->Beranda_model->get_all_ded_()->num_rows();
    ...
    public function masterdata(){
        $data['Ded_m']  = $this->Ded_m;
        $data['ded']    = $this->Ded_m->get_all_ded2()->result();
    ...
    public function user_data(){   
        ...
        $data['skpa_list']  = $this->Ded_m->get_all_ded_()->result();
    ...
    public function post_user(){
        ...
        $this->form_validation->set_rules('id_skpa','SKPA','required');
