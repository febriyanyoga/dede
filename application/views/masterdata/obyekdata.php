...
<div class="row">
                            ...
                            <tbody>
                                ...
                                foreach ($obyek_data as $obj) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;"><?php echo $obj->objek_data; ?></td>
                                        <td style="text-align: center;">

                                            <a style="color: white;" class="btn btn-success" href="<?php echo site_url('Parameter/').$obj->id_objek_data; ?>"><i class="fa fa-edit"></i>Tabel Data Parameter</a>
                                            ...
                                            <a href="<?php echo site_url('hapus_obj/'.$obj->id_objek_data); ?>"  onClick="return confirm('Anda yakin akan menghapus Objek Data <?php echo $obj->objek_data; ?>?')" style="color: white;" class="btn btn-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="editskpa-<?php echo $obj->id_objek_data; ?>" tabindex="-1" role="dialog" aria-labelledby="editskpa">
                                        <div class="modal-dialog" role="document">
                                            <form action="<?php echo site_url('update_objek'); ?>" method="post">
    ...
    <div class="modal fade" id="tambahobyekdata" tabindex="-1" role="dialog" aria-labelledby="tambahskpa">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url('post_objek');?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
