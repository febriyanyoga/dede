...
<div class="row">
                                ...
                                foreach ($ded as $d) {
                                    if ($d->nama_skpa != '') {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a style="color: white;" class="btn btn-success" href="<?php echo site_url('Organisasi/'.$d->id_skpa); ?>">Organisasi</a>
                                        ...
                                        <div class="modal fade" id="editskpa-<?php echo $d->id_skpa; ?>" tabindex="-1" role="dialog" aria-labelledby="editskpa">
                                            <div class="modal-dialog" role="document">
                                                <form action="<?php echo site_url('update_skpa'); ?>" method="post">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
    ...
    <div class="modal fade" id="tambahskpa" tabindex="-1" role="dialog" aria-labelledby="tambahskpa">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url('post_skpa'); ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo site_url('post_dokumen'); ?>" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                ...
                                foreach ($data as $key) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?php echo site_url('hapus_dokumen/').$key->id_dokumen; ?>" onClick="return confirm('Anda yakin akan menghapus dokumen <?php echo $key->nama_dokumen; ?>?')" style="color: white;" class="btn btn-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                } ?>
