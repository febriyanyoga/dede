...
<div class="row">
                            ...
                            <tbody>
                                ...
                                foreach ($organisasi as $or) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;"><?php echo $or->nama_organisasi; ?></td>
                                        ...
                                        <td style="text-align: center; min-width: 200px;">
                                            ...
                                            <a href="<?php echo site_url('hapus_org/').$or->id_organisasi; ?>"  onClick="return confirm('Anda yakin akan menghapus organisasi <?php echo $or->nama_organisasi; ?>?')" style="color: white;" class="btn btn-sm btn-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="editorganisasi-<?php echo $or->id_organisasi; ?>" tabindex="-1" role="dialog" aria-labelledby="editskpa">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <form action="<?php echo site_url('post_update_organisasi'); ?>" method="post">
    ...
    <div class="modal fade " id="tambahorganisasi" tabindex="-1" role="dialog" aria-labelledby="tambahorganisasi">
        <div class="modal-dialog modal-lg" role="document">
            <form action="<?php echo site_url('post_organisasi'); ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
