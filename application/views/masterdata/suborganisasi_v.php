...
<div class="row">
                            ...
                            <tbody>
                                ...
                                foreach ($sub_organisasi as $subor) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;"><?php echo $subor->nama_suborganisasi; ?></td>
                                        ...
                                        <td style="text-align: center; min-width: 200px;">
                                            ...
                                            <a href="<?php echo site_url('hapus_suborg/').$subor->id_suborganisasi; ?>"  onClick="return confirm('Anda yakin akan menghapus sub organisasi <?php echo $subor->nama_suborganisasi; ?>?')" style="color: white;" class="btn btn-sm btn-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="editorganisasi-<?php echo $subor->id_suborganisasi; ?>" tabindex="-1" role="dialog" aria-labelledby="editskpa">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <form action="<?php echo site_url('update_suborganisasi'); ?>" method="post">
    ...
    <div class="modal fade" id="tambahskpa" tabindex="-1" role="dialog" aria-labelledby="tambahskpa">
        <div class="modal-dialog modal-lg" role="document">
            <form action="<?php echo site_url('post_sub_organisasi'); ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
