...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table" style="border-top: 1px none;">
                        ...
                        <tr>
                            <th> Tugas </th>
                            <td><?php echo $sub_organisasi[0]->tugas_sub; ?></td>
                        </tr>
                        <tr>
                            <th>Fungsi</th>
                            <td>
                                <?php if(empty($sub_organisasi[0]->fungsi_sub)){
                                    echo "Tidak ada fungsi";
                                }else{
                                    echo $sub_organisasi[0]->fungsi_sub; 
                                }
                                ?>
                            </td>
                        </tr>
                ...
                <br>
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambahtabel"><i class="fas fa-plus-circle"></i> Tambah Parameter</button>
                <p>
                    <?php
                                ...
                                foreach ($parameter as $par) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="<?php echo site_url('hapus_par/').$par->id_parameter; ?>"  onClick="return confirm('Anda yakin akan menghapus parameter <?php echo $par->nama_parameter; ?>?')" style="color: white;" class="btn btn-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="editparam-<?php echo $par->id_parameter; ?>" tabindex="-1" role="dialog" aria-labelledby="editparam">
                                        <div class="modal-dialog" role="document">
                                            <form action="<?php echo site_url('update_parameter'); ?>" method="post">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="exampleModalLabel1">Data Parameter <?php echo $par->nama_parameter; ?></h4>
    ...
    <div class="modal fade" id="tambahtabel" tabindex="-1" role="dialog" aria-labelledby="tambahskpa">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url('post_parameter'); ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Tambah Parameter</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
