...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Monitoring untuk <b><?php cetak($skpa->nama_peraturan); ?></b></h4>
                <br>
                            ...
                            foreach ($note as $n) {
                                ...
                                <tr>
                                    ...
                                    <td  class="text-center">
                                        ...
                                        <a href="<?php echo site_url('hapus_note/').$n->id_note; ?>"  onClick="return confirm('Anda yakin akan menghapus <?php echo $n->judul; ?>?')" style="color: white;" class="btn btn-danger"><i class="ti-trash"></i></a>
                                    </td>
                                </tr>
