                            ...
                            foreach ($data_user as $user) {
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 100px;" class="text-center">
                                        ...
                                        <a href="<?php echo site_url('hapus_usr/').$user->id_users?>"  onClick="return confirm('Anda yakin akan menghapus <?php echo $user->full_name?>?')" style="color: white;" class="btn btn-danger"><i class="ti-trash"></i></a>
                                    </td>
                                </tr>

                                <!-- start modal edit -->
                                <div class="modal fade" id="edit-<?php echo $user->id_users?>" tabindex="-1" role="dialog" aria-labelledby="edit-<?php echo $user->id_skpa?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="id_skpa">
                                                            <?php
                                                            foreach ($skpa_list as $list) {
                                                                if($user->id_skpa == $list->id_skpa){
                                                                    ?>
                                                                    <option selected value="<?php echo $list->id_skpa?>"><?php echo $list->nama_skpa?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                                <option value="<?php echo $list->id_skpa?>"><?php echo $list->nama_skpa?></option>
                                                                <?php
                                                            }
                                                            ?>
                                                        </select>
