           ...
           <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        <h2 class="m-b-0 font-light">&nbsp <?php echo cetak($jumlah_skpa);?></h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        <h2 class="m-b-0 font-light">&nbsp<?php cetak($jumlah_org);?></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        <h2 class="m-b-0 font-light">&nbsp<?php cetak($jumlah_suborg);?></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        <h2 class="m-b-0 font-light">&nbsp<?php cetak($jumlah_obj);?></h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            foreach($ded as $d){
                               ...
                               <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#dokumen-<?php cetak($d->id_skpa)?>">Detail</button>
                                </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Dokumen Pendukung - <b><?php cetak($key->nama_peraturan)?> </b></h4>
                    ...
                    <table id="zero_config-<?php echo $key->id_skpa?>" class="table table-striped table-bordered display">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $key) {
                                ...
                                <tr>
                                    <td><?php cetak($i);?></td>
                                    <td><?php cetak($key->nama_dokumen);?></td>
                                    <td class="text-center">
