...
class Beranda_model extends CI_Model
{
    ...
    function get_all_ded_(){
        $this->db->select('*');
        $this->db->from('tbl_skpa');
        $this->db->where('nama_skpa != ""');
        $this->db->order_by('id_skpa', 'ASC');
        $query = $this->db->get();
        return $query;
    }
    ...
    function get_all_data($id_skpa){
        ...
        $this->db->join('tbl_objek_data D','P.id_objek_data = D.id_objek_data','right');
        $this->db->join('tbl_suborganisasi S','D.id_suborganisasi = S.id_suborganisasi','right');
        $this->db->join('tbl_organisasi O','S.id_organisasi = O.id_organisasi','right');
        $this->db->join('tbl_skpa K','O.id_skpa = K.id_skpa','right');
